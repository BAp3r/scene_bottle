...
analyze(os.path.join(ROOT_DIR, "usds", "objects", "gr2v4_1_0_fourier_hand_6dof", "gr2v4_1_0_fourier_hand_6dof.usd"))
analyze(os.path.join(ROOT_DIR, "usds", "objects", "thor_table.usd"))
analyze(os.path.join(ROOT_DIR, "usds", "objects", "SM_BottleA.usd"))
