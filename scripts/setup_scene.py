...
TABLE_USD     = os.path.join(ROOT_DIR, "usds", "objects", "thor_table.usd")
BOTTLE_USD    = os.path.join(ROOT_DIR, "usds", "objects", "SM_BottleA.usd")
ROBOT_USD     = os.path.join(ROOT_DIR, "usds", "objects",
                              "gr2v4_1_0_fourier_hand_6dof",
                              "gr2v4_1_0_fourier_hand_6dof.usd")
OUTPUT_USD    = os.path.join(ROOT_DIR, "usds", "scene_usd", "scene_grasp.usd")
